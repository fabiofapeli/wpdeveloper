																...
																<div id="marketpressprompt-box">
																	...
																	if ( ! CoursePress_Capabilities::is_pro() ) {
																		...
																		echo sprintf( __( 'The full version of MarketPress has been bundled with %s.<br />' .
																		                  'To start selling your course, you will need to activate MarketPress: <br /> %s<br /><br />', 'coursepress' ), 'CoursePress Pro', '<a target="_blank" href="' . admin_url( 'admin.php?page=' . $this->screen_base . '_settings' . '&tab=cp-marketpress' ) . '">' . __( 'Begin Activating MarketPress', 'coursepress' ) . '</a>' );
																	}
																	?>
																</div>
