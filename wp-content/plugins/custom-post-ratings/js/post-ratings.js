    ...
    $( '#post-rating span' ).click( function( e ) {
        if ( vote ) {
            ...
            $.ajax({
                ...
                url: url_ajax,
                data: {
                    action: 'vote', //Variável obrigatória para identificação de qual ação será realizada em admin-ajax.php
                    rating: $( this ).data( 'id' ),
...
var url_ajax = 'http://localhost:8080/wordpress/wp-admin/admin-ajax.php';